...
def parse_arguments():
    ...
    parser.add_argument('--content_dir',type=str, default=r'C:\Users\ankit\OneDrive\Desktop\projects\New folder\NST_Code\content_data',help='Location of content dataset')

    parser.add_argument('--style_dir',type=str, default=r'C:\Users\ankit\OneDrive\Desktop\projects\New folder\NST_Code\style_data',help='Location of style dataset')

    parser.add_argument('--vgg',type=str, default=r'C:\Users\ankit\OneDrive\Desktop\projects\New folder\NST_Code\vgg_normalised.pth',help='Location of pre-trained VGG')
